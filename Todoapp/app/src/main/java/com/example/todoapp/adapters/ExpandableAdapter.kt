...
class ExpandableAdapter(var titleList:ArrayList<String>, var map:HashMap<String,ArrayList<String>>):BaseExpandableListAdapter() {
    ...
    override fun getChildView(
        ...
        val list = titleList[groupPosition]
        val childItem = list[childPosition]
        childItemView.findViewById<TextView>(R.id.name_child).text = childItem.toString()
